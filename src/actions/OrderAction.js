...
export const myOrders = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get("/api/v1/orders/me",{withCredentials:"include"});
...
export const getOrdersDetails = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`/api/v1/order/${id}`,{ withCredentials:"include" });
...
export const allOrders = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get("/api/v1/admin/orders",{ withCredentials:"include" },config);
...
export const deleteOrder = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`/api/v1/admin/order/${id}`,{ withCredentials:"include" });
