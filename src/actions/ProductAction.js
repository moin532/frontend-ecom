...
export const getProduct =(keyword = "", currentPage = 1, price = [0, 10000], category) =>
  async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(link,{withCredentials:"include"});
...
export const getProductDetails = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`/api/v1/product/${id}`,{withCredentials:"include"});
...
export const getAdminProducts = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get("/api/v1/admin/products",{withCredentials:"include"});
...
export const DeleteProducts = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`/api/v1/admin/products/${id}`,{withCredentials:"include"});
