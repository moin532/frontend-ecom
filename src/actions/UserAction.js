...
export const loadUser = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get('/api/v1/me',{withCredentials:"include"})
...
export const logout = () => async (dispatch) => {
  try {
    ...
    await axios.get('/api/v1/logout',{withCredentials:true} ,config);
...
export const getAllusers = ()=>async(dispatch)=>{
  ...
  try {
    ...
    const {data} = await axios.get('/api/v1/admin/users',{withCredentials:"include"})
...
export const getusersDetails = (id)=>async(dispatch)=>{
  try {
    ...
    const {data} = await axios.get(`/api/v1/admin/user/${id}`,{ withCredentials:"include" })
